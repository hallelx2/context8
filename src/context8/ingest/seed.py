...
logger = logging.getLogger("context8.ingest.seed")

SEED_NAMESPACE = uuid.UUID("c0c8c0c8-0000-0000-0000-000000000008")
...
def _record_from_seed(data: dict) -> ResolutionRecord:
    kwargs = dict(
    ...
    if "slug" in data:
        kwargs["id"] = slug_to_id(data["slug"])
